...
/**
 * Locker App — Rider Landing Page (Monochrome)
 *
 * Use this as `apps/web/app/page.tsx` (Next.js App Router) or a standalone component.
 * Tailwind required. Framer Motion optional.
 *
 * Design goals per request:
 *  - Rider‑only UX (owners page will be separate)
 *  - High‑contrast, black‑and‑white UI so photography pops later
 *  - Minimal, confident layout inspired by utilitarian brands (e.g., Uber)
 */
